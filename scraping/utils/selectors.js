export const SELECTORS = {
  ...
  cincoNorte: {
    producto: ".one-third",
    nombre: ".title",
    URL: { selector: ".product-info__caption", atributo: "href" }, //se debe agregar web+selector para que diriga a la url
    precio: ".current_price",
    imagen: { selector: ".image-element__wrap img", atributo: "data-src" }, //se debe agregar https:+selector para dirigir a la url
  },
  decathlon: {
  ...
  velo: {
    ...
    URL: { selector: ".ProductItem__Wrapper a", atributo: "href" }, //web + selector
  ...
  specialized: {
    ...
    URL: { selector: "a.product-image", atributo: "href" }, // web + selector
